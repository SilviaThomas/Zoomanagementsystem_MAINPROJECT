...
<?php
  ...
  if ($conn->connect_error) {
    ...
    // {
      ...
      $log_sql = "INSERT INTO tbl_login VALUES (null,'$email','$encrpass',2,1)";
      if(mysqli_query($conn, $log_sql)){
          ...
          $sql = "INSERT INTO `tbl_zookeeperreg` VALUES(null, $login_id, '$firstname', '$lastname',1)";
          // -- echo $sql;
          if(mysqli_query($conn, $sql)){
          
            
             
            echo '<script>window.location.href="addzookeeper.php";</script>';
